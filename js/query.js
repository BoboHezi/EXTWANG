...
<div class="gaohao_info"><a target="_blank" href="${data.company_name ? 'https://www.tianyancha.com/search?key=' + data.company_name : 'javascript:;'}">
    ...
    <p></p>
    <p>邮箱: ${data.mail} 注册资金: ${data.regist_cost} 店铺名称: ${data.shop_name} 法人: ${data.boss_name} 注册号: ${data.regist_num} 店铺UID: ${data.shop_uid} 位置: ${data.positon} 社会信用代码: ${data.credit_code} 公司状态: ${data.company_status}</p>
</div>`)
    return msg;
}